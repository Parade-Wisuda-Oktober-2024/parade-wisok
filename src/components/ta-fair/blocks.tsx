  ...
  return (
    ...
    <div className="relative flex-col justify-center items-center">
      ...
      <div className="flex flex-row flex-1 justify-center items-center space-x-4 h-full"> {/* container */}
        {/* INPUT PLACEHOLDER */}
        <div
          className="relative h-full flex justify-between items-center w-[90%] bg-[#401571cc] border-[#fee59a] border-solid border-2 rounded">
          ...
          <div className="relative h-full flex justify-center items-center w-full m-2">
            <input placeholder="Cari wisudawan"
                   className="bg-[#401571cc] placeholder-[#fee59a] font-sub-sub-header rounded-md flex-1"/>
          </div>
        </div>
        <div
          className="relative flex w-[10%] h-full justify-center items-center bg-[#401571cc] border-[#fee59a] border-solid border-2 rounded p-2">
          <DropdownMenu>
      ...
      <div className="flex space-x-2 justify-center items-center">
        ...
        <div className="bg-[rgb(250,230,149)] z-0 justify-center items-center rounded-full w-10 h-10">
          ...
          <div
            className="relative inset-0 flex z-10 bg-[url('/back-vector.png')] bg-contain bg-no-repeat w-10 h-10 justify-center items-center text-[rgba(45,37,73,255)]"></div>
        </div>
        <NumberCarouselActive
        >1</NumberCarouselActive>
        <NumberCarouselInactive>2
        </NumberCarouselInactive>
        <NumberCarouselInactive>3
        </NumberCarouselInactive>
        <NumberCarouselInactive>4
        </NumberCarouselInactive>
        <NumberCarouselInactive>5
        </NumberCarouselInactive>
        <div className="bg-[rgb(250,230,149)] z-0 justify-center items-center rounded-full w-10 h-10">
          <div
            className="relative inset-y-2.5 inset-x-3.5 flex z-10 bg-[url('/next-vector.png')] bg-contain bg-no-repeat w-5 h-5 justify-center items-center"
