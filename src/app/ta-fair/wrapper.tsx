...
export function BlocksLayout({
  ...
  return (
    <div className="bg-[url('/organogram/innerlight.png')] border border-purple-500 bg-cover bg-center object-center rounded-[20px] w-full md:w-3/4 lg:w-full h-96 p-1">
      <div
...
export function NumberCarouselInactive({
  ...
  return (
    <div className="bg-[rgba(45,37,73,255)] z-0 justify-center items-center rounded-full w-10 h-10">
      ...
      <div
        className="relative inset-0 flex z-10 bg-[url('/Ellipse-1.png')] bg-contain bg-no-repeat w-10 h-10 justify-center items-center text-[rgb(250,230,149)]">
        {children}
      </div>
    </div>
  );
...
export function NumberCarouselActive({
  ...
  return (
    <div className="bg-[rgb(250,230,149)] z-0 justify-center items-center rounded-full w-10 h-10">
      <div
        className="relative inset-0 flex z-10 bg-[url('/Ellipse-1.png')] bg-contain bg-no-repeat w-10 h-10 justify-center items-center text-[rgba(45,37,73,255)]">
        {children}
      </div>
    </div>
  );
...
export function TADetailLayout({
  ...
  return (
    <div
      className="relative bg-[url('/tafair.png')] bg-no-repeat z-0 justify-center items-center flex flex-col w-full min-h-screen rounded-2xl">
