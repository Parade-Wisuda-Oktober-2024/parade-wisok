        ...
        <form id="loginForm" onSubmit={handleSubmit(onSubmit)}
          ...
          <div className='relative'>
            ...
            <button type="button" onClick={togglePasswordVisibility}
                    className="absolute right-2 top-1 p-1 bg-transparent opacity-70 text-gray-600 hover:text-gray-900">
              {showPassword ? (<Image src={'/login/view.png'} alt='view password' width={20} height={20}/>) : (
                <Image src={'/login/hide.png'} alt='hide password' width={20} height={20}/>)}
            </button>
          </div>
          <button type="submit"
