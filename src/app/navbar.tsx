...
const NavBar = () => {
  ...
  return(
    <div>
      {sidebar && <Sidebar setSidebar={setSidebar} taFair={taFair} graduates={graduates} merchandise={merchandise} sponshorship={sponshorship} aboutUs={aboutUs} />}
      <div className="h-[73px] xl:h-[100px] w-full">
        <div className="bg-[url('/navbar-bg.png')] w-full h-full bg-center relative bg-cover">
          <div className="bg-[url('/ornament.png')] w-full h-full bg-center bg-cover flex xl:justify-between px-4 xl:px-[40px] bg-opacity-60">
            <div className="flex items-center justify-between gap-2 w-full">
              ...
              <div onClick={()=>setSidebar(true)} className="w-[23.9px] h-[18.59px] xl:hidden"><Image src={burger} alt="dropdown" objectFit="contain"/></div>
            </div>
